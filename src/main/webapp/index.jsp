	...
	<div class="container">
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<p>
						<a href="./furediBlog/stories">Entries</a>
					</p>
		...
		<article>
			<c:forEach items="${entries}" var="entry">
				<header>
					<h1>Ez itt a cim</h1>
					<p>Posted on September 31, 2015 at 10:00 PM</p>
				</header>
		...
		<footer>
			<p th:text="#{footerText}">Készült a Stark Industtries
				megbízásából</p>
		</footer>
